...
from oxt_utils import load_oxts_packets_and_poses,cam_to_w,w_to_cam
...
if __name__ == '__main__':
    ...
    oxt_dir = "data/KITTI/data_tracking_oxts/training/oxts"
    calib_dir = "data/KITTI/resources/training/calib"
    save_root = './results/'
    ...
    for seq_file in seq_file_list:
        ...
        oxt_file = os.path.join(oxt_dir, seq_name + '.txt')
        calib_file = os.path.join(calib_dir, seq_name + '.txt')
        ...
        if seq_dets.shape[1] == 0:
            ...
            continue
        #read oxts
        oxts = load_oxts_packets_and_poses([oxt_file])
        ...
        for frame in range(min_frame, max_frame + 1):
            ...
            dets_all = {'dets': dets, 'info': additional_info, 'I2V': calib.I2V, 'T_w_imu':oxts[frame].T_w_imu}
